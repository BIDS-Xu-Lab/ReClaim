#!/bin/bash
#SBATCH --job-name=baseline_process
...
#SBATCH --output=slurm_job_logs/baseline_process_%j.out
#SBATCH --error=slurm_job_logs/baseline_process_%j.err



echo "=================================="
echo "Baseline Process Job Starting"
echo "=================================="
...
TOKEN_FEATURE_TYPES=("count" "binary")
...
RECLAIM_DATA_DIR="${PROCESSED_MARKETSCAN_DATA_ROOT}/v${VERSION}/marketscan_full_combined"
...
# ###########
# STEP 1: Find Prediction Point (produces both train and val splits)
###########
echo "=================================="
echo "STEP 1: Find Prediction Point"
echo "=================================="

${CONDA_PYTHON} preprocess_find_prediction_point_for_train.py \
...
###########
# STEP 2: Feature Processing (run for both train and val, for each token feature type)
###########
