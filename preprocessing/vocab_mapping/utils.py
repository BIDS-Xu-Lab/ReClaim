...
def setup_logging(script_path=None, capture_print = True):
    """
    ...
    if capture_print:
        ...
        logger.info(f"Logger initialized: {log_file} (print capture enabled)")
    else:
...
def time_execution(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        logging.info(f"Function '{func.__name__}' executed in {formatted_time}")
        return result
    return wrapper
